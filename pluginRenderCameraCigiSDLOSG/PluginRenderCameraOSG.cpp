...
{
public:
	KeyboardHandler( PluginRenderCameraCigiSDLOSG *plug ) 
	{
		plugin = plug;
	}
...
private:
	PluginRenderCameraCigiSDLOSG *plugin;
};
...
EXPORT_DYNAMIC_CLASS( PluginRenderCameraCigiSDLOSG )

// ================================================
// PluginRenderCameraCigiSDLOSG
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
PluginRenderCameraCigiSDLOSG::PluginRenderCameraCigiSDLOSG() : Plugin() 
{
	name_ = "PluginRenderCameraCigiSDLOSG";
...
// ~PluginRenderCameraCigiSDLOSG
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
PluginRenderCameraCigiSDLOSG::~PluginRenderCameraCigiSDLOSG() throw() 
{
...
// act
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::act( SystemState::ID state, StateContext &stateContext )
{
...
// operate
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::operate()
{
...
// getConfig
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::getConfig()
{
...
// analyzeScene
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::analyzeScene( osg::Node *node, int level ) 
{
...
// analyzeLODs
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::analyzeLODs( osg::Node *node, int level ) 
{
	if( node == NULL ) node = rootNode;
...
// openWindow
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::openWindow()
{
	if( haveOpenedWindow )
		return;
...
// setupSDLViewer
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::setupSDLViewer()
{
	if( calledSDLInit )
		return;
...
// setupViewports
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::setupViewports()
{
	if( viewMap == NULL )
		return;
...
// updateViewports
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::updateViewports()
{
/*
	std::map< int, RefPtr<View> >::iterator vpIter = viewMap->begin();
	for( ; vpIter != viewMap->end(); vpIter++ )
	{
		...
		if( view == NULL )
		{
			std::cerr << "ERROR in PluginRenderCameraCigiSDLOSG::updateViewports() - viewMap contains a NULL entry\n";
			break;
		}
...
*/
	...
	for( ; vpIter != viewportMap.end(); vpIter++ )
	{
		...
		{
			std::cerr << "ERROR in PluginRenderCameraCigiSDLOSG::updateViewports() - viewportMap contains a NULL entry\n";
			break;
		}
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::changeActiveViewports( SystemState::ID state )
{
...
// toggleFullscreen
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::toggleFullscreen()
{
...
// changeResolution
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::changeResolution()
{
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::cycleThroughDisplaySettings()
{
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::modifyDisplaySettings(bool increment)
{
	if(displaySettings.size() == 0) return;
...
// reportSDLError
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void PluginRenderCameraCigiSDLOSG::reportSDLError()
{
