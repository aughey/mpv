 ...
 *      Initial release.  Replaces the old ProcCompCtrl class.  Uses the 
...
ProcCompCtrl::ProcCompCtrl( mpv::EntityContainer *entContainer ) :
...
// OnPacketReceived
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
void ProcCompCtrl::OnPacketReceived( CigiBasePacket *Packet )
{
	CigiCompCtrlV3_3 *compCtrl = static_cast<CigiCompCtrlV3_3 *> (Packet);
	...
	{
		// entity not found!
		std::cout << "Warning - in ProcCompCtrl::OnPacketReceived() - entity " 
