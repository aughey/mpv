...
#ifndef _VELOCITYVECTOR_H_
#define _VELOCITYVECTOR_H_
...
//! 
//! 
class VelocityVector : public SymbolSet
{
public:
	//=========================================================
	//! General Constructor
	//! 
	VelocityVector( CigiOutgoingMsg &message, HUDState *h );
...
protected:
	...
	void velocityVectorPositionChanged( HUDState * );
	
	mpv::RefPtr<HUDState> hudState;
	
	mpv::RefPtr<SymbolCircle> pip;
	mpv::RefPtr<SymbolLine> waterlineReference;
