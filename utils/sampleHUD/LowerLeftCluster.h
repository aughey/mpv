...
#ifndef _LOWERLEFTCLUSTER_H_
#define _LOWERLEFTCLUSTER_H_
...
//! 
//! 
class LowerLeftCluster : public SymbolSet
{
public:
	//=========================================================
	//! General Constructor
	//! 
	LowerLeftCluster( CigiOutgoingMsg &message, HUDState *h );
...
protected:
	...
	//! General Destructor
	//! 
	virtual ~LowerLeftCluster();
	
	void textChanged( HUDState * );
