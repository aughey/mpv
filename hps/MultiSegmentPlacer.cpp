...
osgParticleHPS::MultiSegmentPlacer::MultiSegmentPlacer()
: Placer(), total_length_(0)
{
}
    
osgParticleHPS::MultiSegmentPlacer::MultiSegmentPlacer(const MultiSegmentPlacer &copy, const osg::CopyOp &copyop)
: Placer(copy, copyop), vx_(copy.vx_), total_length_(copy.total_length_)
{
}

void osgParticleHPS::MultiSegmentPlacer::recompute_length()
{
...
void osgParticleHPS::MultiSegmentPlacer::setPosition(Particle *P) const
{
    if (vx_.size() >= 2) {
