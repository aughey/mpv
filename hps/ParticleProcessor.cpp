...
osgParticleHPS::ParticleProcessor::ParticleProcessor()
:    osg::Node(),
...
osgParticleHPS::ParticleProcessor::ParticleProcessor(const ParticleProcessor &copy, const osg::CopyOp &copyop)
...
void osgParticleHPS::ParticleProcessor::traverse(osg::NodeVisitor &nv)
{
    ...
    if (cv) {
        ...
        if (ps_.valid())
        {
            ...
            {
                osg::notify(osg::WARN) << "osgParticleHPS::ParticleProcessor::traverse(NodeVisitor&) requires a valid FrameStamp to function, particles not updated.\n";
            }
