...
#ifndef _LABEL_ELEMENT_FACTORY_H_
#define _LABEL_ELEMENT_FACTORY_H_

#include "EntityElementFactory.h"


class LabelElementFactory : public mpvosg::EntityElementFactory
{
public:
	LabelElementFactory();
	virtual ~LabelElementFactory();
