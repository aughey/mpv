...
#ifndef ENTITYLISTHANDLER_H
#define ENTITYLISTHANDLER_H
...
class EntityListHandler : public EHS
{
public:
	EntityListHandler();
	...
	void setEntityList( std::list<Entity*> *elist );
	void setViewParamsMap( std::map< int, ViewParams * > *vpm );
