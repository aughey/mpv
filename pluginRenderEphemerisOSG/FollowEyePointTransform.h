 ...
 *  
 *  
 *  FILENAME:   FollowEyePointTransform.h
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
#ifndef FOLLOW_EYE_POINT_TRANSFORM_H
#define FOLLOW_EYE_POINT_TRANSFORM_H
...
#ifndef _MSC_VER
#warning "FIXME - SKY_DOME_RADIUS is defined in two places"
#endif
...
//!
class FollowEyePointTransform : public osg::Transform
{
public:
...
//=========================================================
//! This class is a transform node that can be used to cause a 
//! subgraph to "follow" the eyepoint around.  Also scales the subgraph along 
//! the Z axis, to give the impression that the user is high in the atmosphere.
//! Note - most this class was grabbed from one of the 
//! OSG example programs -ads
//!
class FollowEyePointTransformWithCompression : public osg::Transform
{
public:
